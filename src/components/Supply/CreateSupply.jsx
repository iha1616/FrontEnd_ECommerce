  ...
  return (
    ...
    >
      ...
      <div className="w-2/4">
        ...
        <button
          type="submit"
          className="w-full text-black bg-custom-blue hover:bg-custom-blue-light focus:ring-4 focus:outline-none focus:ring-ring-custom-blue-light font-medium rounded-lg text-sm px-5 py-2.5 text-center"
...
export function CreateButtomSupply() {
  ...
  return (
    <button
      className="flex items-center justify-center border border-gray-400 text-black bg-custom-blue hover:bg-custom-blue-light focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2"
      style={{ backgroundColor: '#3EABCF' }}
      type="button"
      onClick={() => handleOpen()}
    >
