...
import { useGetAllSupplyQuery } from '../../context/Api/Common'
import { UpdateButtomSupply } from './UpdateSupply'
...
const ListSupply = () => {
  ...
  return (
    ...
    <button
      className="flex items-center justify-center border border-gray-400 text-black bg-custom-blue hover:bg-custom-blue-light focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 gap-3"
